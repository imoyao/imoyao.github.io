...
```
注意：如果是json/pickle 文件可以使用`rb`格式写，这样才是原子性的，参见[Can it work with pickle.dump/json.dump instead of text only ? · Issue #29 · untitaker/python-atomicwrites](https://github.com/untitaker/python-atomicwrites/issues/29)
